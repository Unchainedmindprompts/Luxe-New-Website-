...
export const productPages: Record<string, ProductPageData> = {
  ...
  "cellular-shades": {
    ...
    expertInsight: "After 24 years of installing these, here's what most companies won't tell you: the cell size matters more than most people think. A 3/4-inch double cell is the sweet spot for most Northern Idaho homes — it gives you substantial insulation without looking bulky. And if you have large windows facing the lake or the mountains, a top-down/bottom-up option lets you keep your view while still insulating the lower portion of the window. I've installed these in everything from 1960s ranch homes to brand-new builds, and the difference in comfort is something homeowners notice immediately.",
    features: [
  ...
  "solar-shades": {
    ...
    metaTitle: "Solar Shades, North Idaho | Glare & UV for Lake Views",
    metaDescription: "Custom solar shades for North Idaho lake homes. Cut glare, UV, and heat gain while keeping your view. Free consultation in Coeur d'Alene, Sandpoint, Post Falls.",
  },
  "roller-shades": {
    slug: "roller-shades",
    name: "Roller Shades",
  ...
  "banded-shades": {
    ...
    metaTitle: "Banded Shades, North Idaho | Modern Zebra & Dual Shades",
    metaDescription: "Custom banded (zebra) shades for North Idaho homes. Flexible light control with a modern look. Free in-home consultation in Coeur d'Alene, Post Falls, Hayden.",
  },
  "roman-shades": {
    slug: "roman-shades",
    name: "Roman Shades",
    ...
    metaTitle: "Roman Shades, North Idaho | Custom Fabric Window Shades",
    metaDescription: "Custom Roman shades for North Idaho homes. Premium fabrics, expert installation. Free in-home consultation in Coeur d'Alene, Post Falls, Sandpoint.",
  },
  "shutters": {
    slug: "shutters",
  ...
  "exterior-solar-shades": {
    ...
    gallery: [
      { src: "/images/IMG_0983.jpeg", alt: "Motorized exterior solar shade install on a covered deck by Luxe Window Works in North Idaho" },
      { src: "/images/IMG_1422.jpeg", alt: "Exterior solar shade install on a North Idaho home by Luxe Window Works" },
    ],
    ...
    metaTitle: "Exterior Solar Shades, North Idaho | Corradi Screens",
    metaDescription: "Corradi USA exterior solar shades for North Idaho — motorized Somfy retractable screens. Block heat before it hits the glass. Free in-home consultation.",
  },
  "motorization": {
    slug: "motorization",
    name: "Motorization",
    ...
    secondVideo: {
      ...
      description: "Motorized window shades from Luxe Window Works. Push-button operation, no cords, safe for kids and pets, and perfect for hard-to-reach windows. Serving Coeur d'Alene, Post Falls, Hayden, Rathdrum, and Sandpoint in North Idaho. Free in-home consultations and 24 years consulting, designing, and installing window treatments.",
