 ...
 * the two forms and their exact fields, Resend for delivery, and the four
 ...
 *
 * The window-treatment advisor section was removed when that page was withdrawn
 * from the site. A policy describing a feature a visitor cannot reach is as
 * wrong as one omitting a feature they can.
 *
      ...
      <div className="bg-warm-white">
        <div className="container-luxe max-w-3xl py-16 md:py-20">
          ...
          <Section title="What you give us">
            <p>
              Two places on this site ask for information: the contact form and
              the consultation request on the booking page. Between them they
              collect your <strong>name, phone number, email address, street
              address, city, a description of what you need</strong>, and how you
