...
export const metadata: Metadata = {
  ...
  description: 'Explore custom cellular, banded (Zebra), and Roman shade pricing for your North Idaho home. Enter your window sizes and compare light control and motorization.',
  robots: { index: false, follow: false },
};
export default function EstimatePage() {
  return <>
    <EstimateExperience bandedImage={productPages["banded-shades"].image!} />
