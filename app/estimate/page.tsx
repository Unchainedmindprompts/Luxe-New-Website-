...
export const metadata: Metadata = {
  title: 'Instant Cellular & Banded Shade Estimate | Luxe Window Works',
  description: 'Explore custom cellular and banded (Zebra) shade pricing for your North Idaho home. Enter your window sizes and compare light control and motorization.',
