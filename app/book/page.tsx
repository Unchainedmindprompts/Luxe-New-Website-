      ...
      <div className="bg-charcoal text-white pt-28 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-warm-gray-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Mark personally visits your home to see your windows, understand your goals, and
            recommend the right solution. No pressure, no guesswork — just honest advice from
            someone who&apos;s been doing this for nearly 20 years.
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-3">
          {submitted ? (
            <div className="bg-white rounded-2xl border border-warm-gray-200 p-10 text-center shadow-sm">
              ...
              <h2 className="font-serif text-2xl font-bold text-charcoal mb-3">Request Received!</h2>
              <p className="text-warm-gray-600 leading-relaxed mb-6">
                Thank you, {form.firstName}. Mark will personally reach out within{" "}
                <strong>24 hours</strong> to schedule your free in-home consultation at a time
                that works for you.
              </p>
              <p className="text-sm text-warm-gray-500 mb-8">
                ...
                or email{" "}
                <a href="mailto:mark@luxewindowworks.com" className="text-gold font-medium hover:text-gold-dark">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-warm-gray-200 p-8 shadow-sm space-y-5">
              <h2 className="font-serif text-xl font-semibold text-charcoal">Your Information</h2>
              ...
              {field("address", "Home Address", "text", "123 Main St, Post Falls, ID")}
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Which rooms? Any specific goals — privacy, energy efficiency, a particular style? Any windows that are tricky?"
              ...
              >
                {submitting ? "Sending your request…" : "Request My Free Consultation"}
              </button>

              <p className="text-center text-xs text-warm-gray-400">
                Mark will personally follow up within 24 hours &middot; No spam, ever
              </p>
            </form>
          )}
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              {[
                ...
                <div key={step.num} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-warm-gray-600 leading-relaxed">{step.body}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-charcoal rounded-2xl p-7 text-white">
            <div className="flex items-center gap-1 mb-1">
              ...
              <span className="text-warm-gray-400 text-sm ml-1">· 14 Google reviews</span>
            </div>
            <p className="text-warm-gray-300 text-sm italic leading-relaxed mt-3 mb-4">
              &ldquo;Mark was incredibly knowledgeable and patient. He helped us find the perfect
              solution for our tricky west-facing windows. The installation was flawless.&rdquo;
            </p>
            <div className="border-t border-white/10 pt-4 space-y-2 text-sm">
              <div className="flex items-center gap-2 text-warm-gray-300">
                ...
                <a href="tel:+12086608643" className="hover:text-white transition-colors">
                  208-660-8643
                </a>
              </div>
              <div className="flex items-center gap-2 text-warm-gray-300">
                ...
                <a href="mailto:mark@luxewindowworks.com" className="hover:text-white transition-colors">
                  mark@luxewindowworks.com
                </a>
              </div>
            </div>
          ...
          <p className="text-xs text-warm-gray-400 text-center px-2">
            Serving Coeur d&apos;Alene, Post Falls, Hayden, Rathdrum &amp; Sandpoint, ID
          </p>
        </div>
      </div>
    </div>
